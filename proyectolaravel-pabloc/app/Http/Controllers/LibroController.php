...
class LibroController extends Controller
{
    ...
    {
        $libro = new Libro();
        $autores=Autore::pluck("apellidos","id");//Extrae los los valores de los nombres y los id's
        return view('libro.create', compact('libro',"autores"));
    }
    ...
    {
        $libro = Libro::find($id);
        $autores=Autore::pluck("nombre","id");//Extrae los los valores de los nombres y los id's
